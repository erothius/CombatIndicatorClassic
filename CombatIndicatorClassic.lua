...
z:SetPoint("Right", TargetFrame, 0, 15)
z:SetSize(35, 35)
z.t = z:CreateTexture(nil, BORDER)
z.t:SetAllPoints()
z.t:SetTexture("Interface\\Icons\\ABILITY_DUALWIELD")
z:Hide()
...
y:SetPoint("Left", FocusFrame, -40, 9)
y:SetSize(35, 35)
y.t = y:CreateTexture(nil, BORDER)
y.t:SetAllPoints()
y.t:SetTexture("Interface\\Icons\\ABILITY_DUALWIELD")
y:Hide()
